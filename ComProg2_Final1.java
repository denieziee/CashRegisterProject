...
public class ComProg2_Final1 {
    ...
    private static void logTransaction(String username, ArrayList<String> itemNames, ArrayList<Integer> itemQuantities, ArrayList<Double> itemPrices, double total) {
        String filePath = "c:\\Users\\Zeane Denel G. Capuy\\Documents\\NOTES\\2ND SEM\\ComProg 2\\codes\\transactions.txt";

        Transaction transaction = new Transaction(username, new ArrayList<>(itemNames), new ArrayList<>(itemQuantities), new ArrayList<>(itemPrices), total);
    ...
    private static class Transaction {
        ...
        public Transaction(String cashier, List<String> items, List<Integer> quantities, List<Double> prices, double total) {
        ...
        public String toString() {
            ...
            for (int i = 0; i < items.size(); i++) {
                sb.append(items.get(i))
                  ...
                  .append(", Price: Php ").append(String.format("%.2f", prices.get(i)))
                  .append("\n");
            }
            sb.append("\nTotal Amount: Php ").append(String.format("%.2f", total)).append("\n");
            sb.append("-----------------------------------------------------------\n");
            return sb.toString();
        }
    }
